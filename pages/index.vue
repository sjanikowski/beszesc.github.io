  ...
  <div id="main" class="w-full overflow-hidden leading-tight sm:leading-normal tracking-normal text-black duration-400">
      ...
      <div class="container max-w-4xl mx-auto m-8">
        ...
        <div class="p-6 content-center">
          <h3 class="text-[11px] sm:text-[22px] text-black font-['RedHatDisplay'] font-medium leading-5 sm:leading-10 mb-3 text-center">
              ...
              ten rok, spoglądając na historie tworzących ją osób, docenić to, co <i>Beczka</i> przeszła i to, czym 
    ...
    >
      ...
      <div class="p-6 content-center">
        ...
        <div class="text-[16px] sm:text-[24px] font-extrabold text-left content-normal pt-20 pb-10 sm:py-16">
          Jak inaczej możesz<br><b>nas wesprzeć</b>
        </div>
    ...
    <section id="newsletter">
      <div class="pl-[40px] md:pl-[340px] pr-[40px] 2xl:pr-[240px] sm:pt-16 sm:pb-32 mb-12">
        ...
        <div id="blendnews" class="blend-news md:inline-block md:float-right w-[250px] h-[250px] min-[1900px]:pr-0 2xl:w-[400px] 2xl:h-[400px] min-[1900px]:w-[500px] min-[1900px]:h-[500px] py-20 md:py-0">
    </div>    
      </div>
...
export default Vue.extend({
  ...
  watch: {
    scrollY(newValue: number) {
      ...
      var valYidea = document.getElementById("idea")?.getBoundingClientRect().y ?? -100;
